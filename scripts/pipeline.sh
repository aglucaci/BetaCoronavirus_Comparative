...
echo qsub -V -W depend=afterok:$jobid_2a -q epyc -o $BASEDIR"/scripts/STDIN" -e $BASEDIR"/scripts/STDIN_Error" -N Beta_tn93_codons tn93_codons.sh -F $BASEDIR
cmd="qsub -V -W depend=afterok:$jobid_2a -q epyc -o $BASEDIR"/scripts/STDIN" -e $BASEDIR"/scripts/STDIN_Error" -N Beta_tn93_codons tn93_codons.sh -F $BASEDIR"
...
echo qsub -V -W depend=afterok:$jobid_2c -o $BASEDIR"/scripts/STDIN" -e $BASEDIR"/scripts/STDIN_Error" -q epyc -l nodes=1:ppn=28 MEME_BUSTEDS_aBSREL.sh -F $BASEDIR
cmd="qsub -V -W depend=afterok:$jobid_2c -o $BASEDIR"/scripts/STDIN" -e $BASEDIR"/scripts/STDIN_Error" -q epyc -l nodes=1:ppn=28 MEME_BUSTEDS_aBSREL.sh -F $BASEDIR"
